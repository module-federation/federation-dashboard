...
const WhiskerChart = React.memo((props) => {
    ...
    const whiskerChartOptions = {
        ...
        legend: {
            cursor: "pointer",
            itemclick: (e)=>{props.toggleDataSeries(e); gotRef.render()},
        },
    ...
    return (
        <CanvasJSChart
            ...
            onRef={(ref)=>{setRef(ref);createRef(ref)}}
        />
    )
})
...
const TimeSeriesChart = React.memo((props) => {
    ...
    return (
        <CanvasJSChart
            ...
            onRef={(ref)=>{createRef(ref);setRef(ref)}}
        />
    )
})
    ...
    render() {
        ...
        return (
            <>
                ...
                <div>
                    <WhiskerChart whiskerChartData={this.props.whiskerChartData}
                                  toggleDataSeries={this.toggleDataSeries}/>
                    <ScatterChart scatterChartData={this.props.scatterChartData}
                                  toggleDataSeries={this.toggleDataSeries}/>
                    <MultiSeriesChart multiSeriesChartData={this.props.multiSeriesChartData}
                                      toggleDataSeries={this.toggleDataSeries}/>
